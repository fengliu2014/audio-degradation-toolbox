function [f_audio_out,timepositions_afterDegr] = degradationUnit_applyLowpassFilter(f_audio, samplingFreq, timepositions_beforeDegr, parameter)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Name: degradation_applyLowpassFilter
% Date: 2013-04
% Programmer: Matthias Mauch
%
% Description:
% - applies a lowpass filter to the audio
%
% Input:
...
if isfield(parameter,'passFrequency')==0
    parameter.passFrequency = 0.5 * parameter.stopFrequency;
end
